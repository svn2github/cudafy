...
namespace Cudafy.WarpShuffleFunctions
{
    public static class WarpFuncs
    {
        ...
        {
            throw new CudafyException(CudafyException.csX_NOT_SUPPORTED, "Shuffle");
        }

        public static int ShuffleUp(this GThread thread, int var, uint delta, int width = WARP_SIZE)
        {
            throw new CudafyException(CudafyException.csX_NOT_SUPPORTED, "ShuffleUp");
        }

        public static int ShuffleDown(this GThread thread, int var, uint delta, int width = WARP_SIZE)
        {
            throw new CudafyException(CudafyException.csX_NOT_SUPPORTED, "ShuffleDown");
        }

        public static int ShuffleXor(this GThread thread, int var, int laneMask, int width = WARP_SIZE)
        {
            throw new CudafyException(CudafyException.csX_NOT_SUPPORTED, "ShuffleXor");
        }
