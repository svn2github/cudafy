...
namespace Cudafy.Compilers
{
    ...
    public abstract class CompilerOptions : ICompilerOptions
    {
        ...
        protected CompilerOptions(string name, string compilerPath, string includeDirectory)
        {
...
#warning Try calling nvcc.exe
        ...
        /// Checks if include directory exists.
        /// </summary>
        /// <exception cref="CudafyCompileException">File or directory not found.</exception>
        public virtual void Test()
        {
            ...
            {
                throw new CudafyCompileException(CudafyCompileException.csCOMPILATION_ERROR_X, ex.Message);
            }
