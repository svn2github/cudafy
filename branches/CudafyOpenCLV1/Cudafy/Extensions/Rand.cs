...
//Sobol64_t  state)
        ...
        {
            throw new CudafyException(CudafyException.csX_NOT_SUPPORTED, "curand_normal_double");
        }
        ...
        {
            throw new CudafyException(CudafyException.csX_NOT_SUPPORTED, "curand_uniform");
        }
